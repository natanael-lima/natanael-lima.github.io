...
const texts = {
	'en': {
	  ...
	  'descriptionaboutme': '🖐¡Hi! I am Analista Programador Universitario from Jujuy, Argentina. With knowledge in developing web applications and desktop applications and data organization. My skill as a developer is reflected in the implementation of practical and efficient solutions. through coding in different languages ​​such as Java, C# and frameworks such as Spring Boot, .Net. I am responsible, organized and enjoy work as a team to achieve project objectives. As a passionate software developer, I am excited to contribute to the world of technology.',
	  ...
	  'card4title': 'Applications System Management',
